...
from app.utils.helpers.azure_openai_chatgpt import AzureOpenAIChatGPT
from app.utils.schemes.input.conversation_samples import content_simple_example, get_content_image_sample, get_content_pdf_sample
from app.utils.schemes.input.conversations import Content, UserMessage
from app.utils.schemes.input.conversations import ImageMessage, PDFMessage
...
def simple_sample(api_key: str = Depends(get_api_key)):
    return JSONResponse(content=jsonable_encoder(content_simple_example.to_dict()),status_code=status.HTTP_200_OK)
